...
- (void)setHtml_test:(NSString *)html{
...
//    NSString *insertTitleJS = [NSString stringWithFormat:@"ZSSEditor.insertTitle(\"%@\");",title];
//    
//    [self.webView stringByEvaluatingJavaScriptFromString:insertTitleJS];
}

- (void)addBodyContent:(NSString *)body{
    
    
    bodyContent = body;
    bodyBool = YES;
    NSString* javascript = [NSString stringWithFormat:@"%@.setHTML(\"%@\");", [self wrappedNodeJavascriptAccessor], bodyContent];
    NSLog(@"============%@",bodyContent);
    [self.webView stringByEvaluatingJavaScriptFromString:javascript];
...
- (void)setPlaceholderText:(NSString*)placeholderText
{
    ...
    if (!self.domLoaded) {
        ...
        if (titleBool) {
            ...
            NSString *insertTitleJS = [NSString stringWithFormat:@"ZSSEditor.insertTitle(\"%@\");",titleContent];
...
- (void)setPlaceholderBodyText:(NSString*)placeholderText
{
