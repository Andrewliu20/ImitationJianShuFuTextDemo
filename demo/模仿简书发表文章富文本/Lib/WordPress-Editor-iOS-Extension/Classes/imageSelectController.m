...
//    NSMutableArray *textData = @[CustomLocalisedString(@"photoLibrary",@"从相册中选择"),CustomLocalisedString(@"takePhoto",@"拍照"),CustomLocalisedString(@"insertImageFromInternet",@"插入网络图片")];
    NSMutableArray *textData = @[@"从相册中选择",@"拍照"];
