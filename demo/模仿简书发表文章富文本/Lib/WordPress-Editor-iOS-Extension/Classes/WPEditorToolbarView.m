...
#define BUTTON_W [UIScreen mainScreen].bounds.size.width/5+6

static int kDefaultToolbarItemPadding = 30;
static int kDefaultToolbarLeftPadding = 8;

static int kNegativeToolbarItemPadding = 20;
...
static const CGFloat WPEditorToolbarButtonHeight = 60;
static const CGFloat WPEditorToolbarButtonWidth = 80;
...
- (void)reloadiPhoneItems
{
    ...
    self.toolbarScroll.contentSize = CGSizeMake(0,self.frame.size.width);
                       ...
                       accessibilityLabel:(NSString*)accessibilityLabel
{
    ...
    UIImage* buttonImage = [image imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    
    CGRect buttonSize;
    if (IS_IPAD) {
        buttonSize = CGRectMake(0.0, 0.0, WPEditorToolbarButtonWidthiPad, WPEditorToolbarButtonHeightiPad);
    } else {
        buttonSize = CGRectMake(0.0, 0.0, BUTTON_W, WPEditorToolbarButtonHeight);
    }
...
//    NSLog(@"===%@",[NSString stringWithFormat:@"%@%@.png",imageName,@"H"]);
//    [customButton setImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@%@.png",imageName,@"H"]] forState:UIControlStateHighlighted];
...
- (ZSSRichTextEditorToolbar)defaultToolbarItems
{
    ...
    if(saveKeys){
     ...
     defaultToolbarItems = (ZSSRichTextEditorToolbarKeyBoardHidden|ZSSRichTextEditorToolbarInsertImage
        ...
        [saveKeys addObject:@(ZSSRichTextEditorToolbarKeyBoardHidden)];
