...
//    _allItemsDatas = @[@{@"icon":@"icon_format_media",@"title": @"插入图片或视频",@"key":@(ZSSRichTextEditorToolbarInsertImage)},
...
//                       ];
    _allItemsDatas = @[@{@"icon":@"icon_format_media",@"title": @"插入图片或视频",@"key":@(ZSSRichTextEditorToolbarInsertImage)},
                       @{@"icon":@"icon_format_bold",@"title":@"粗体",@"key":@(ZSSRichTextEditorToolbarBold)},
                       @{@"icon":@"icon_format_italic",@"title": @"斜体",@"key":@(ZSSRichTextEditorToolbarItalic)},
                       @{@"icon":@"ZSSsubscript",@"title":@"下标",@"key":@(ZSSRichTextEditorToolbarSubscript)},
                       @{@"icon":@"ZSSsuperscript",@"title": @"上标",@"key":@(ZSSRichTextEditorToolbarSuperscript)},
                       @{@"icon":@"icon_format_strikethrough",@"title": @"删除线",@"key":@(ZSSRichTextEditorToolbarStrikeThrough)},
                       @{@"icon":@"icon_format_underline",@"title": @"下划线",@"key":@(ZSSRichTextEditorToolbarUnderline)},
                       @{@"icon":@"ZSSclearstyle",@"title":@"清除格式",@"key":@(ZSSRichTextEditorToolbarRemoveFormat)},
                       @{@"icon":@"ZSSleftjustify",@"title": @"左对齐",@"key":@(ZSSRichTextEditorToolbarJustifyLeft)},
                       @{@"icon":@"ZSScenterjustify",@"title":@"居中",@"key":@(ZSSRichTextEditorToolbarJustifyCenter)},
                       @{@"icon":@"ZSSrightjustify",@"title": @"右对齐",@"key":@(ZSSRichTextEditorToolbarJustifyRight)},
                       @{@"icon":@"ZSSforcejustify",@"title": @"两端对齐",@"key":@(ZSSRichTextEditorToolbarJustifyFull)},
                       @{@"icon":@"ZSSh1",@"title":@"一级标题",@"key":@(ZSSRichTextEditorToolbarH1)},
                       @{@"icon":@"ZSSh2",@"title": @"二级标题",@"key":@(ZSSRichTextEditorToolbarH2)},
                       @{@"icon":@"ZSSh3",@"title":@"三级标题",@"key":@(ZSSRichTextEditorToolbarH3)},
                       @{@"icon":@"ZSSh4",@"title":@"四级标题",@"key":@(ZSSRichTextEditorToolbarH4)},
                       @{@"icon":@"ZSSh5",@"title":@"五级标题",@"key":@(ZSSRichTextEditorToolbarH5)},
                       @{@"icon":@"ZSSh6",@"title": @"六级标题",@"key":@(ZSSRichTextEditorToolbarH6)},
                       @{@"icon":@"ZSStextcolor",@"title": @"文字颜色",@"key":@(ZSSRichTextEditorToolbarTextColor)},
                       @{@"icon":@"ZSSbgcolor",@"title": @"背景颜色",@"key":@(ZSSRichTextEditorToolbarBackgroundColor)},
                       @{@"icon":@"icon_format_ul",@"title":@"无序列表",@"key":@(ZSSRichTextEditorToolbarUnorderedList)},
                       @{@"icon":@"icon_format_ol",@"title": @"有序列表",@"key":@(ZSSRichTextEditorToolbarOrderedList)},
                       @{@"icon":@"ZSShorizontalrule",@"title": @"插入水平线",@"key":@(ZSSRichTextEditorToolbarHorizontalRule)},
                       @{@"icon":@"ZSSindent",@"title": @"缩进",@"key":@(ZSSRichTextEditorToolbarIndent)},
                       @{@"icon":@"ZSSoutdent",@"title": @"减少缩进",@"key":@(ZSSRichTextEditorToolbarOutdent)},
                       @{@"icon":@"icon_format_link",@"title":@"插入链接",@"key":@(ZSSRichTextEditorToolbarInsertLink)},
                       @{@"icon":@"icon_format_unlink",@"title":@"移除链接",@"key":@(ZSSRichTextEditorToolbarRemoveLink)},
                       @{@"icon":@"ZSSquicklink",@"title": @"快速链接",@"key":@(ZSSRichTextEditorToolbarQuickLink)},
                       @{@"icon":@"ZSSundo",@"title":@"撤销",@"key":@(ZSSRichTextEditorToolbarUndo)},
                       @{@"icon":@"ZSSredo",@"title":@"重做",@"key":@(ZSSRichTextEditorToolbarRedo)},
                       @{@"icon":@"icon_format_quote",@"title": @"引用",@"key":@(ZSSRichTextEditorToolbarBlockQuote)}
                       ];
    [self initView];
}
-(void)initView{
