...
typedef NS_ENUM(NSInteger, ZSSRichTextEditorToolbar) {
    ...
    ZSSRichTextEditorToolbarKeyBoardHidden = 1 << 33,
    ZSSRichTextEditorToolbarFontStyleHidden = 1 << 34
};
...
typedef enum
{
    ...
    kWPEditorViewControllerElementHiddenKeybButton,
    kWPEditorViewControllerElementFontStyleButton
